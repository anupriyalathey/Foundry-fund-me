...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA-RPC-URL) --private-key $(PRIVATE-KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN-API-KEY) -vvvvv
